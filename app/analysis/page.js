...
export default async function AnalysisPage({ searchParams }) {
  ...
  const cascadeOptions = {
    ...
    minLongShare: Number(params?.minLongShare || 0.65),
  ...
  return <AnalysisDashboard datasets={datasets} chosen={chosen} rows={rows} stats={stats} cascadeOptions={cascadeOptions} />;
}
